...
int main()
{
    ...
    do
    {
        ...
        cout << "Press 3. For Update To Data" << endl;
        cout << "Press 4. For Delete First Data" << endl;
        cout << "Press 5. For Delete Last Data" << endl;
        cout << "Press 6. For Delete Any Position Data" << endl;  // ✅ Added missing menu option
